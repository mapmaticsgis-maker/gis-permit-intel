# Permit Market Brief — 2026-08-18
...
- 7-day issuance: **121** (prior 7-day: 194, -38% vs prior week)

**Accelerating**

- COTERRA ENERGY OPERATING CO. — 8 this week (+8)
- EOG RESOURCES, INC. — 8 this week (+7)
- OCCIDENTAL PERMIAN LTD. — 8 this week (+6)
- MEWBOURNE OIL COMPANY — 6 this week (+6)
- MCM OPERATING, LLC — 5 this week (+5)

**Decelerating**

- CATURUS ENERGY, LLC — 0 this week (-5)
- BPX OPERATING COMPANY — 0 this week (-8)
- PIONEER NATURAL RES. USA, INC. — 17 this week (-8)
- DE CENTRAL OPERATING, LLC — 0 this week (-13)
- DIAMONDBACK E&P LLC — 7 this week (-23)
...
- MTD issuance: **384** over 12 business days, tracking to ~**672** (baseline ~750)
- Basin mix: Permian 62%, Other 20%, Eagle Ford 14%, East Texas gas 4%
...
- 2026-08: 4/384 (1%)  *(inside spud-reporting lag)*

- Aging inventory: **209** permits issued 45+ days ago, still unspudded
...
- PIONEER NATURAL RES. USA, INC. — 98 permits, 8 spuds seen
...
- MEWBOURNE OIL COMPANY — 24 permits, 1 spuds seen

**Amendment clusters** — block-wide refiling often precedes drilling

- DIAMONDBACK E&P LLC — PEGGY 20-8 (3 permits refiled)

**Corridor — DLS / EOG — Giddings & Eastern Eagle Ford, trailing 90 days**

- MAGNOLIA OIL & GAS OPERATING LLC — 18 (FAYETTE, LEE, WASHINGTON)
...
New in this corridor this week: 6

**Corridor — DOXA / Sabine — East Texas, trailing 90 days**

- SABINE ENERGY INC. — 15 (HARRISON, PANOLA, RUSK)
...
- SABALO II OPERATING, LLC — 8 (ANDREWS)
...
- Newest issue date in master: 2026-08-14 (4 day(s) behind as-of date)
...
- 156 records in the LA master. Reported separately from TX by design — parish activity and Texas county activity are not directly comparable, and Haynesville spans the state line.
