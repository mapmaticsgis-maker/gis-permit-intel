# Permit Market Brief — 2026-09-25
...
- Permits issued: **0** (30-day average 11/business day, baseline ~35)
...
- MTD issuance: **156** over 19 business days, tracking to ~**181** (baseline ~750)
...
- Aging inventory: **1057** permits issued 45+ days ago, still unspudded
...
- PIONEER NATURAL RES. USA, INC. — 117 permits, 18 spuds seen
...
- PIONEER NATURAL RES. USA, INC. — 63 (ANDREWS, MIDLAND, UPTON)
...
- APACHE CORPORATION — 16 (MIDLAND, UPTON)
- FASKEN OIL AND RANCH, LTD. — 14 (ANDREWS)
- FIREBIRD ENERGY II LLC — 14 (ECTOR)
- BLACKBEARD OPERATING, LLC — 13 (CRANE, WINKLER)
...
- Newest issue date in master: 2026-09-04 (21 day(s) behind as-of date)
...
- 196 records in the LA master. Reported separately from TX by design — parish activity and Texas county activity are not directly comparable, and Haynesville spans the state line.
